 ...
 * @author ydorr
 */
public class AnnulerSponsoringController implements Initializable {
...
//
            ...
            alert.setContentText("Êtes-vous sûr de vouloir annuler cet sponsoring ?");
        ...
        a.setTitle("Sponsoring annulé");
                 String content = String.format("Le sponsor est supprimé avec succés.");
   ...
   if (s.getID_sponsors() != 0  ) {IDsuppEV.setText(String.valueOf(s.getID_sponsors()));
       ...
       String d =s.getNom()+" sonsorise l'evenement "+s.getNom_Evenement().getNom_ev();
      ErreurRechercheS.setText(d); 
      }
    
   else {
     String d ="Il n'etes pas un sponsor! ";
    ErreurRechercheS.setText(d); 
