 ...
 * @author ydorr
 */
public class HomeParticipantsController implements Initializable {
...
evenements e = new evenements();
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       pnItems.getChildren().clear();
        ...
        for(int i = 0; i<Event.size() ; i++)
        {
                ...
                fxmlLoader.setLocation(getClass().getResource("/GUI/ItemParticipantEvenement.fxml"));
    ...
    private void BTNModifierParT(ActionEvent event) throws IOException {
        ...
        // Récupérer le stage actuel et changer sa scène pour la nouvelle interface
        Stage stage = (Stage)  btnModifPart.getScene().getWindow();
         // Modifier la scène de la fenêtre pour la nouvelle scène
        stage.setScene(scene);
         // Afficher la nouvelle interface
        stage.show();
    ...
    private void BTNSupprimerPart(ActionEvent event) throws IOException {
         // Charger le fichier FXML de la nouvelle interface
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SupprimerPartAcceuil.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
