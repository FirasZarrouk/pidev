 ...
 * @author ASUS
 */
public class PayeeerrController implements Initializable {
   ...
   @FXML
    ...
    FormationServices cs =new FormationServices();
   ...
   void getFormation(Formation f){
    ...
    void cancelOnaction(ActionEvent event) {
        FormationServices formServ =new FormationServices();
        ...
        if (namefield.getText().length() == 0 ||cvcfield.getText().length() == 0||expyearfield.getText().length() == 0||expmonthfield.getText().length() == 0||numberTextfield.getText().length()==0){
            ...
            try {
               /* if (PanierController.promocodeEtat==true) { //ken promocode activee twali montant b discount
                    ...
                    stp.verifyCardAndPay(cardNumber, expMonth, expYear, cvc, cardholderName, String.valueOf((int) f.getPrix() * 100));
                //}
